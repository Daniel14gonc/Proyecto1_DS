...
public class Interprete {
  ...
  /**
   * Método reset
   * Instancia todo lo que se utiliza nuevamente como
   * si se iniciara el programa por primera vez
   */
  private void reset(){
    funciones = new HashMap<String, Funcion>();
    comparable = new Comparable();
  ...
  public String evaluar(List<Object> ListEvaluar) throws Exception{
    ...
    try{
      if(!ListEvaluar.isEmpty())
      {
        ...
        {
          /**
           * Si se encuentra que existe una instancia de String
           * en este punto se trabaja con las funciones dirigidas
           * a Strings
           */
          ...
          /**
           * Si se encuentra que existe una instancia de object
           * en este punto se trabaja con las funciones dirigidas
           * a objects
           */
